    ...
    <div class="container d-flex flex-wrap justify-content-center items-center text-center pb-5 mb-5">
        <div class="row gy-3 justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-body">
                        <h5 class="fw-bold">#1234568</h5>     
                        <h5 class="fw-bold">€1,00</h5>                   
                    </div>
                </div>
            </div>
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                      ...
                      <ul class="list-group list-group-flush">
                        <li class="list-group-item">Hamburger 1x €1,00</li>
                        <li class="list-group-item">Medium friet 5x €5,00</li>
                        <li class="list-group-item">Big mac 1x €2,00</li>
                        <li class="list-group-item">20 Nuggets 2x €6,00</li>
                        <li class="list-group-item">Cheeseburger 1x €1,00</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="row mt-3 text-center gy-3">
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-body">
                  <h6 class="fw-light text-danger">Eventuele foutmelding</h6>
                </div>
              </div>
            </div>
        </div>
